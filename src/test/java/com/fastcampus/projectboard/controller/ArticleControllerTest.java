...
class ArticleControllerTest {
    ...
    public void givenNothing_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        // Given
        Long articleId = 1L;
        given(articleService.getArticleWithComments(articleId)).willReturn(CreateInstance.createArticleWithCommentsDto());
        // When & Then
    ...
    @Test
    public void givenNothing_whenRequestingArticlesPage_thenRedirectsToLoginPage() throws Exception {
        // Given
        long articleId = 1L;
        // When & Then
        mvc.perform(get("/articles/" + articleId))
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnsSearchArticleHashtagView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
    ...
    @DisplayName("[view][POST] 새 게시물 등록 - 정상 호출")
    @Test
    void givenNewArticleInfo_whenRequesting_thenSavesNewArticle() throws Exception {
        // Given
        ArticleRequest articleRequest = ArticleRequest.of("title", "content", "#new");
    ...
    void givenUpdatedArticleInfo_whenRequesting_thenUpdatesArticle() throws Exception {
        // Given
        Long articleId = 1L;
        ArticleRequest articleRequest = ArticleRequest.of("updated title", "updated content", "#updated");
